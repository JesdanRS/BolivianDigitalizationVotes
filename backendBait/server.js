...
const votoManualRoutes = require("./services/votaciones/routes/votoManualRoutes");
...
app.use(
  cors({
    origin: [
      ...
      "http://localhost:5173",
      "http://localhost:5174",
    ], // Ajusta según tu puerto del frontend
    credentials: true,
...
app.get("/", (req, res) => {
  res.json({
    message:
      "🗳️ API de Votaciones - Sistema de Digitalización de Votos Bolivia",
    version: "1.0.0",
    endpoints: {
      usuarios: {
...
// Rutas de votos manuales
app.use("/api/votaciones/votos-manuales", votoManualRoutes);
