...
public class OpenApiConfig {
	...
	@Value("${api.common.title:API Candidatos - Sistema de Votaciones Bolivianas}")
	private String title;

	@Value("${api.common.description:Microservicio para la gestión de candidatos en el sistema de digitalización de votaciones bolivianas}")
