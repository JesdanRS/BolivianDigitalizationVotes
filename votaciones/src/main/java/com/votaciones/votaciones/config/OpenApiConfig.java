...
public class OpenApiConfig {
	...
	@Value("${api.common.title:API Votaciones - Sistema de Votaciones Bolivianas}")
	private String title;

	@Value("${api.common.description:Microservicio para la gestión de votaciones en el sistema de digitalización de Bolivia}")
