        ...
        <div style={{ fontFamily: 'Arial, sans-serif', background: '#f9fafb', minHeight: '100vh' }}>
            ...
            <div style={{ padding: '24px 40px', width: '95%', maxWidth: '100%', margin: 0 }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                    <h1 style={{ fontSize: '1.6rem', fontWeight: 800, margin: 0 }}>Registro de Acciones Electorales</h1>
                    <button
                        type="button"
                ...
                {/* Descripción del Req_005 */}
                <p style={{ color: '#6b7280', marginBottom: 20, fontSize: '0.95rem' }}>
                    Sistema de registro inalterable de todas las acciones electorales para garantizar transparencia e integridad.
                    Cada registro incluye: fecha, hora, usuario y acción realizada.
                </p>
                ...
                <form onSubmit={onSearch} style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 16 }}>
                    ...
                    <Select value={tipo} onChange={e => setTipo(e.target.value)}>
                        {['TODO', 'LOGIN', 'LOGIN_FALLIDO', 'VOTO_EMITIDO', 'CREAR_CANDIDATO', 'ACTUALIZAR_CANDIDATO', 'ELIMINAR_CANDIDATO', 'ERROR', 'CONSULTA', 'CARGA_MASIVA_USUARIOS',
                            'SOLICITAR_CODIGO', 'VERIFICAR_CODIGO_OK', 'VERIFICAR_CODIGO_FALLIDO'].map(v => <option key={v}>{v}</option>)}
                    </Select>
