...
const Input = (props) => (
  <input
    ...
    style={{
      ...
      border: "1px solid #e5e7eb",
      borderRadius: 10,
      width: props.type === "datetime-local" ? 200 : 260,
    }}
  />
);
const Button = (props) => (
      ...
      >
        ...
        >
          <h1 style={{ fontSize: "1.6rem", fontWeight: 800, margin: 0 }}>
            Registro de Acciones Electorales
          </h1>
          <button
            type="button"
        ...
        <p style={{ color: "#6b7280", marginBottom: 20, fontSize: "0.95rem" }}>
          Sistema de registro inalterable de todas las acciones electorales para
          garantizar transparencia e integridad. Cada registro incluye: fecha,
          hora, usuario y acción realizada.
        </p>
        ...
        >
          ...
          <Select value={sev} onChange={(e) => setSev(e.target.value)}>
            {["TODO", "INFO", "WARN", "ERROR", "CRITICAL"].map((v) => (
              <option key={v}>{v}</option>
            ))}
          </Select>
