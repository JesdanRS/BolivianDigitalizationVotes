      ...
      <div style={{
        ...
        <div style={{
          ...
          <form 
            ...
            <div style={{
              ...
              <div style={{
                ...
                <label htmlFor="recordarme" style={{ color: '#666666', fontSize: '14px' }}>Recordarme</label>
              </div>
          ...
          <p style={{ 
            ...
            ¿Eres administrador? <a href="#" style={{ color: '#dc2626', textDecoration: 'none' }}>Inicia sesión aquí</a>
          </p>
        </div>
      </div>
